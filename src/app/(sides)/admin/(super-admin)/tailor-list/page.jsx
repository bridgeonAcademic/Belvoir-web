                  ...
                  <table className="min-w-full table-auto text-gray-700 border-collapse border border-gray-300">
                    <thead>
                      <tr className="bg-black text-white">
                        <th className="py-3 px-6 border border-gray-300 text-left font-semibold">Tailor Name</th>
                        <th className="py-3 px-6 border border-gray-300 text-left font-semibold">Email</th>
                        <th className="py-3 px-6 border border-gray-300 text-left font-semibold">Phone Number</th>
                    ...
                    <tbody>
                      {tailors.data?.data?.map((tailor) => (
                        ...
                        >
                          <td className="py-3 px-6 border border-gray-300 font-medium text-gray-800">{tailor.name}</td>
                          <td className="py-3 px-6 border border-gray-300 text-gray-600">{tailor.email}</td>
                          <td className="py-3 px-6 border border-gray-300 text-gray-600">{tailor.phone}</td>
