...
const OrderSummaryTailoring = ({ selectedAddress }) => {
  ...
  const totalPrice = clothPrice + designPrice + shippingfee;
    ...
    <div className=" min-h-screen bg-cover bg-center relative">
      ...
      <div className="relative z-10 p-6 max-w-4xl mx-auto bg-white bg-opacity-60 backdrop-blur-md rounded-lg shadow-lg">
        ...
        <Link href={`/users/clothes/${selectedCloth.id}`}>
          <div className="bg-white bg-opacity-70 backdrop-blur-md p-2 rounded-lg shadow-md mb-6">
        ...
        <Link href={`/users/Design/${selectedDesign.id}`}>
          <div className="bg-white bg-opacity-70 backdrop-blur-md p-1 rounded-lg shadow-lg mb-6">
            <div className="flex items-center gap-4">
              <img
        ...
        <div className="bg-white bg-opacity-70 backdrop-blur-md p-6 rounded-lg shadow-md mb-6">
          <h3 className="font-medium text-gray-700">Measurements</h3>
          <Link href={`/users/Measurements/${selectedDesign.id}`}>
        ...
        <div className="flex justify-end mt-8">
          <button
            ...
            className="mt-2 px-4 py-2 bg-yellow-600 text-white font-semibold rounded-md shadow hover:bg-yellow-700"
          >
            Place Order
          </button>
        </div>
